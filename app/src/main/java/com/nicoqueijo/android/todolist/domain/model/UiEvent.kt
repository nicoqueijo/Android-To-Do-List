...
sealed interface UiEvent {
    ...
    data class EditToDo(val toDo: ToDo): UiEvent // Invokes bottom sheet with title & description fields of selected ToDo
    data class SaveToDo(val toDo: ToDo): UiEvent // Dismiss bottom sheet and save ToDo to the db
